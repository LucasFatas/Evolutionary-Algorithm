...
class Coordinate:
    ...
    # Hash Function
    # @return hash of the Coordinate instance
    def __hash__(self):
    ...
    def dir_to_coordinate_delta(self, direction):
        ...
        dir_map = {Direction.east: Coordinate(1, 0), Direction.north: Coordinate(0, -1),
                   Direction.south: Coordinate(0, 1), Direction.west: Coordinate(-1, 0)}
